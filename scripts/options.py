...
def add_dataset_args(parser):
    ...
    group.add_argument('--max_len', type = int, default = 15, help = 'max span length to consider' )
    return group
...
def add_model_args(parser):
    ...
    group.add_argument('--use_char_emb', action = 'store_true', default = False)
    ...
    group.add_argument('--use_tf', action = 'store_true', default = True)
...
def add_optimization_args(parser):
    ...
    group.add_argument('--grad_clipping', type = float, default = 10)
    group.add_argument('--weight_decay', type = float, default = 0)
    group.add_argument('--loss_fn', type = str, default = 'cel')
